      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <span className="font-bold text-green-900 block text-sm md:text-base">
        ...
        <div className="px-4 pb-4 space-y-3 border-t-2 border-green-200 pt-4">
          ...
          <div className="mt-4 pt-4 border-t-2 border-green-200">
            <div className="flex items-start gap-2 text-xs text-green-800 bg-green-50 rounded-lg p-3">
              ...
              <p>
                <strong>Official Verification:</strong> All information is sourced directly from the Nigerian Tax Reform Bills passed by the National Assembly.
              </p>
            </div>
          </div>
        </div>
